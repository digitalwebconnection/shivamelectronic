        ...
        <div className="bg-linear-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-800  p-6 md:p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 space-y-4 text-center lg:text-left">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-red-500/15 border border-red-500/30 text-red-500 text-[10px] font-black uppercase tracking-wider">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2 pt-2">
                <div className="flex flex-col items-center">
                  <span className="w-12 h-12 rounded-md bg-slate-800 border border-slate-700 flex items-center justify-center text-lg font-black text-white">
              ...
              {actualFlashProducts.map((p, idx) => {
                ...
                return (
                  <div 
                    ...
                    className="group bg-slate-950/45 backdrop-blur-md border border-slate-800/80 hover:border-red-500 rounded-md p-5 flex gap-5 transition-all duration-300 hover:shadow-2xl hover:shadow-red-950/20 hover:-translate-y-0.5 cursor-pointer relative"
                  >
                    ...
                    {/* Discount Badge */}
                    <span className="absolute -top-2.5 left-3 bg-linear-to-r from-red-600 to-rose-500 text-white text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-md shadow-[0_4px_12px_rgba(220,38,38,0.25)] border border-red-500/20 z-10">
                      HOT FLASH DEAL
                    </span>

                    {/* Image panel */}
                    <div className="w-24 h-24 rounded-md bg-slate-900 flex items-center justify-center shrink-0 relative overflow-hidden group-hover:border-red-950 transition-colors">
                      <div className="absolute inset-0 bg-linear-to-br from-red-500/5 to-transparent pointer-events-none" />
                      <img 
                        src={p.image} 
                        alt={p.name} 
                        className="w-full h-full rounded-md transition-transform duration-500 drop-shadow-[0_8px_16px_rgba(0,0,0,0.6)]"
                      />
                    </div>
                    ...
                    <div className="flex-1 flex flex-col justify-between min-w-0">
                      <div>
                        {/* Category tag */}
                        <span className="text-[8px] font-black text-white tracking-widest uppercase block mb-1">
                          {p.category}
                        </span>
                        
                        <h3 className="text-xs sm:text-sm font-extrabold text-white group-hover:text-red-500 transition-colors leading-tight truncate">
                          {p.name}
                        </h3>
                        
                        <div className="flex items-center flex-wrap gap-2 mt-2">
                          <span className="text-[10px] font-extrabold uppercase tracking-wider text-white">Bulk Discount</span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="mt-3.5 py-2 px-3 w-full bg-linear-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 text-white font-black text-[9px] rounded-md tracking-widest flex items-center justify-center gap-1.5 active:scale-95 transition-all shadow-md shadow-red-950/20 cursor-pointer"
                      >
