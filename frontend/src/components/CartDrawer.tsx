...
export const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 z-50 h-full w-full max-w-md bg-white border-l border-slate-200 shadow-2xl transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'
          } flex flex-col`}
      >
        {/* Drawer Header */}
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4 custom-scrollbar">
          {orderSuccessId ? (
            <div className="h-full flex flex-col items-center justify-center text-center py-8 space-y-4">
              ...
              <p className="text-xs text-slate-500 max-w-70 leading-relaxed font-medium">
            ...
            <div className="h-full flex flex-col items-center justify-center text-center pb-12">
              ...
              <p className="text-sm text-slate-500 max-w-62.5 mb-6 font-medium">
